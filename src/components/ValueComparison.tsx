...
const ValueComparison = ({ features, totalValue, dealPrice, savings }: ValueComparisonProps) => {
  return (
    <div className="price-card">
      ...
      <h3 className="text-2xl font-bold mb-6">Everything You're Getting Today:</h3>
      ...
      <div className="border-t border-dashed border-gray-200 pt-6 mb-6">
        <div className="flex justify-between items-center mb-2">
          <span className="text-gray-600">What Others Pay:</span>
          <span className="text-xl font-bold line-through text-gray-500">{totalValue}</span>
        </div>
        <div className="flex justify-between items-center mb-2">
          <span className="text-gray-600">YOUR PRICE TODAY:</span>
      ...
      <p className="text-xs text-gray-500 mt-4 text-center">
        100% Risk-Free: Full 30-day money-back guarantee. No questions asked.
      </p>
    </div>
  );
};
